# java-tsp-samples
This repository contains TypeSpec samples and their corresponding generated Java libraries

## Regenerate Java libraries

To regenerate the Java libraries, run the following command:

```bash
npm install
tsp compile <sample-directory>/tsp/main.tsp
```
...
1. [azure-operations-crud](https://github.com/srnagar/java-tsp-samples/tree/main/azure-operations-crud): This sample demonstrates how to generate CRUD operations.
