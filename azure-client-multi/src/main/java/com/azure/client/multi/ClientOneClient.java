...
public final class ClientOneClient {
    @Generated
    private final ClientOnesImpl serviceClient;

    /**
     * Initializes an instance of ClientOneClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ClientOneClient(ClientOnesImpl serviceClient) {
    ...
    public Response<BinaryData> getFooWithResponse(String fooId, RequestOptions requestOptions) {
        return this.serviceClient.getFooWithResponse(fooId, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Foo getFoo(String fooId, RequestConditions requestConditions) {
        ...
        return getFooWithResponse(fooId, requestOptions).getValue().toObject(Foo.class);
    }
