...
import com.azure.operations.crud.implementation.WidgetManagerClientImpl;
...
public final class WidgetManagerClientBuilder implements HttpTrait<WidgetManagerClientBuilder>,
    ConfigurationTrait<WidgetManagerClientBuilder>, EndpointTrait<WidgetManagerClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("azure-operations-crud.properties");
